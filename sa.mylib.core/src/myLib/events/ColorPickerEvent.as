...
package myLib.events 
{
	...
	/**
	 * The ColorPickerEvent class defines the events that are associated with a ColorPicker component. 
	 * 
	...
	public class ColorPickerEvent extends Event 
	{
		...
		/**
		 * Build a new ColorPickerEvent instance.
		 * @param type The event type as defined in ColorPickerEvent constants.
		 */
