...
package myLib.assets 
{
	...
	/**
	 * MovieAsset is the base class for all components and its children.
	 * Inherit it to build complex asset with components since all IAsset properties and methods are implented here.
	 * MovieAsset inherit from MovieClip, for static assets use Asset class instead.
	 * 
	 * <p>When creating assets in flash library using auto generation class add this class to base class field.</p>
	 * 
	 * @author SamYStudiO
	 */
	public class MovieAsset extends MovieClip implements IMovieAsset
	{
		/**
		 * @private
		 * 
		...
		public function MovieAsset ( )
		{
			...
			//TODO this has been removed from Asset class, check why
