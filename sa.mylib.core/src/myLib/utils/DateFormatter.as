...
package myLib.utils 
{
	...
	public final class DateFormatter 
	{
		 ...
		 */
		public static var MONTHS : Array = new Array( 	"January" ,
														"February" ,
														"March" ,
														"April" ,
														"May" ,
		 ...
		 */
		public static var MONTHS_SHORT : Array = new Array( "Jan" ,
															"Feb" ,
															"Mar" ,
															"Apr" ,
															"May" ,
		 ...
		 */
		public static var WEEKDAY : Array = new Array( 	"Sunday" ,
														"Monday" ,
														"Tuesday" ,
														"Wednesday" ,
														"Thursday" ,
		 ...
		 */
		public static var WEEKDAY_SHORT : Array = new Array( 	"Sun" ,
																"Mon" ,
																"Tue" ,
																"Wed" ,
																"Thu" ,
		...
		private static function __convertPattern ( pattern : String , d : Date ) : String
		{
			switch( true )
			{
				...
				case pattern == "MM"	: 
					return NumberUtils.digitFormat( d.getMonth( ) + 1 );
				case pattern == "MMM"	: 
				...
				case pattern == "dd"	: 
					return NumberUtils.digitFormat( d.getDate( ) );
				case pattern == "D"		: 
					return String( __getDayYearNumber( d ) );
				case pattern == "DD"	: 
					return NumberUtils.digitFormat( __getDayYearNumber( d ) , 3 );
				case pattern == "E"		: 
				...
				case pattern == "ww"	: 
					return NumberUtils.digitFormat( __getWeekYearNumber( d ) );
				case pattern == "h"		: 
					return String( __hour24to12( d.getHours( ) ) );
				case pattern == "hh"	: 
					return NumberUtils.digitFormat( __hour24to12( d.getHours( ) ) );
				case pattern == "H"		: 
					return String( d.getHours( ) );
				case pattern == "HH"	: 
					return NumberUtils.digitFormat( d.getHours( ) );
				case pattern == "m"		: 
					return String( d.getMinutes( ) );
				case pattern == "mm"	: 
					return NumberUtils.digitFormat( d.getMinutes( ) );
				case pattern == "s"		: 
					return String( d.getSeconds( ) );
				case pattern == "ss"	: 
					return NumberUtils.digitFormat( d.getSeconds( ) );
				case pattern == "S"		: 
					return String( d.getMilliseconds( ) );
				case pattern == "SS"	: 
					return NumberUtils.digitFormat( d.getMilliseconds( ) , 3 );
				case pattern == "aa"	: 
		...
		{
			return NumberUtils.isInteger( Number( s ) );
		}
		...
		{
			var monthsLength : Array = new Array( 31 , 28 , 31 , 30 , 31 , 30 , 31 , 31 , 30 , 31 , 30 , 31 );
		...
		private static function __timezoneOffset2String ( n : int, separator : String = "" ) : String
		{
			...
			var min : String = NumberUtils.digitFormat( ( h - Math.floor( h ) ) * 60 );
			var hour : String = NumberUtils.digitFormat( Math.floor( Math.abs( n ) / 60 ) );
		...
		private static function __testTimezoneOffset ( s : String , separator : Boolean = false ) : Boolean
		{
			...
			return ( a[ 0 ] == "+" || a[ 0 ] == "-" ) &&
					!isNaN( a[ 1 ] ) &&
					!isNaN( a[ 2 ] ) &&
					!isNaN( a[ separator ? 4 : 3 ] ) &&
					!isNaN( a[ separator ? 5 : 4 ] );
		}
	}
}
