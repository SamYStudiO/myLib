...
package myLib.ui 
{
	...
	/**
	 * MovieApplication is a base class for main application classes,
	 ...
	 */
	public class MovieApplication extends MovieClip 
	{
		/**
		 * @private
		 */
		...
		/**
		 * Build a new MovieApplication instance.
		 ...
		 */
		public function MovieApplication ( 	frameRate : Number = 30 , align : String = StageAlign.TOP_LEFT , scaleMode : String = StageScaleMode.NO_SCALE , 
