...
package myLib.controls.skins.liquid
{
	 ...
	 */
	public class LiquidTouchScrollSkin extends ALiquidSkin implements ITouchScrollSkin
	{
		/**
		 * @private
		 */
		 ...
		 * 
		 */
		public function LiquidTouchScrollSkin( bitmapSheet : BitmapData )
		{
			super();
			
			_thumbBitmapSheet = bitmapSheet;
		}
		...
		{
			return new LiquidAsset( _thumbBitmapSheet );
		}
	}
}
