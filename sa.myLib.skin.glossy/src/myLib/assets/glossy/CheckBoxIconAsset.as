...
package myLib.assets.glossy
{
	 ...
	 */
	public class CheckBoxIconAsset extends BoxAsset
	{
		/**
		 * @private
		 */
		 ...
		 * 
		 */
		public function CheckBoxIconAsset( size : Number , prop : ShapeAssetProp , selected : Boolean = false , selectedShadowFilter : DropShadowFilter = null )
		{
			super( prop );
		...
		public override function draw(  ) : void
		{
			...
			if( _selected )
			{
				...
				if( _prop.cornerRadius > 0 ) g.drawRoundRect( _width / 4 , _height / 4 , _width / 2 , _height / 2  , _prop.cornerRadius / 2 , _prop.cornerRadius/ 2 );
				else g.drawRect( _width / 4 , _height / 4 , _width / 2 , _height / 2 );
				
				var bevelFilter : BevelFilter = new BevelFilter( 4 , 45 , 0xFFFFFF , .7 , 0x000000 , .7 , _width / 4 ,  _height / 4 , 1 , 2 );
