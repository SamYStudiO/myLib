...
package myLib.controls.skins.glossy
{
	 ...
	 */
	public class GlossySliderButtonSkin extends GlossyButtonSkin
	{
		/**
		 * 
		 */
		public function GlossySliderButtonSkin( mainColor : uint , alternativeColor : uint , stateColor : uint , cornerRadius : Number , shadowFilter : DropShadowFilter = null , innerShadowFilter : DropShadowFilter = null )
		{
