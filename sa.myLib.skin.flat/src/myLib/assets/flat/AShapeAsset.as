...
package myLib.assets.flat
{
	...
	public class AShapeAsset extends Asset
	{
		 ...
		 * @private
		 */
		protected var _fill : Shape = new Shape();
		...
		public function AShapeAsset( prop : ShapeAssetProp )
		{
			...
			_border.filters = prop.borderFilters;
			_fill.filters = prop.filters;
			
			addChild( _border );
			addChild( _fill );
			
			if( _prop.borderStyle == BorderStyle.LINE ) swapChildren( _fill , _border );
		}
	}
}
