...
package myLib.controls.skins.flat
{
	...
	import myLib.assets.flat.EllipseAsset;
	import myLib.assets.flat.RadioButtonIconAsset;
	import myLib.assets.flat.ShapeAssetProp;

	/**
	 * @author SamYStudiO ( contact@samystudio.net )
	 */
	public class FlatRadioButtonSkin extends FlatButtonSkin
	{
		/**
		 * @private
		 */
		 ...
		 * 
		 */
		public function FlatRadioButtonSkin( iconSize : Number , iconProp : ShapeAssetProp , iconSelectedProp : ShapeAssetProp , focusProp : ShapeAssetProp = null , errorProp : ShapeAssetProp = null )
		{
		...
		{
			return new RadioButtonIconAsset( _iconSize , _iconProp );
		}
		...
		{
			return new RadioButtonIconAsset( _iconSize , _iconSelectedProp );
		}
		...
		{
			return new EllipseAsset( _focusProp );
		}
		...
		{
			return new EllipseAsset( _errorProp );
		}
	}
}
